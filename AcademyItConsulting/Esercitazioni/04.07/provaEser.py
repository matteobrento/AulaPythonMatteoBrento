...
class CartaDiCredito(MetodoPagamento):
    ...
    def metodo_pagamento(self):
        ...
        if self.__nome == nome1 and self.__numero_carta == numero_carta1 and self.__data_scadenza == data1 and self.__cvc == cvc1:
...
class PayPal(MetodoPagamento):
    ...
    def metodo_pagamento(self):
        ...
        if user == self.__user and psw == self.__password:
            ...
            if self.__nome == nome2 and self.__numero_carta == numero_carta2 and self.__data_scadenza == data2 and self.__cvc == cvc2:
